...
static inline uint32_t tgetdecorcolor(const Glyph *g) { return g->decor & 0x1ffffff; }
static inline uint32_t tgetdecorstyle(const Glyph *g) { return (g->decor >> 25) & 0x7; }
...
static inline uint32_t tgetimgrow(const Glyph *g) { return g->u & 0x1ff; }
static inline uint32_t tgetimgcol(const Glyph *g) { return (g->u >> 9) & 0x1ff; }
static inline uint32_t tgetimgid4thbyteplus1(const Glyph *g) { return (g->u >> 18) & 0x1ff; }
static inline uint32_t tgetimgdiacriticcount(const Glyph *g) { return (g->u >> 27) & 0x3; }
static inline uint32_t tgetisclassicplaceholder(const Glyph *g) { return (g->u >> 29) & 0x1; }
...
static inline uint32_t tgetimgid(const Glyph *g) {
...
static inline uint32_t tgetimgplacementid(const Glyph *g) {
